...
model_trained = './results/DM_SiameseNet_miniImageNet_Conv64F_5Way_1Shot_K1/model_best.pth.tar'


parser = argparse.ArgumentParser()
parser.add_argument('--dataset_dir', default='../mini-imagenet', help='/miniImageNet')
...
parser.add_argument('--outf', default='./results/DM_SiameseNet')
...
def validate(val_loader, model, criterion, epoch_index, F_txt):
	...
	for episode_index, (query_images, query_targets, support_images, support_targets) in enumerate(val_loader):
		...
		# 	input_var3.append(support_images[i][0])
		#
		# input_var3 = torch.cat(input_var3, 0)
		# input_var3S = input_var3.cuda()
		...
		# output = model(input_var1, input_var2, input_var3S)
