...
model_trained = './results/DM_SiameseNet_miniImageNet_Conv64F_5Way_5Shot_K4/model_best.pth.tar'
...
parser.add_argument('--neighbor_k', type=int, default=4, help='the number of k-nearest neighbors')
...
print(model_trained, file=F_txt)
